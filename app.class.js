...
//calculos genéricos
  ...
  resetInputs(){
	...
	$('#id-paciente').val((day)+(month)+this.day.getFullYear()).trigger("change").trigger("keyup");
  }
		...
		if (Object.keys(data).length > 0) {
			...
			$('#tabla\\.uno > tr').on("click", function(){
				...
				$.post("https://pacientes.crecimientofetal.cl/temporal/primer", args).done(function(data){
					...
					$("#diasEcoGen").val(eg[1]);
					$("#lcn").val(data.temptable_lcn).trigger("change");
					$("#saco").val(data.temptable_saco).trigger("change");
			...
			if (Object.keys(data).length > 0) {
				...
				$('#tabla\\.dos > tr').on("click", function(){
					...
					$.post("https://pacientes.crecimientofetal.cl/temporal/segundo", args).done(function(data){
						...
						$("#semanasEcoGen").val(eg[0]);
						$("#diasEcoGen").val(eg[1]);
						$("#dbp").val(data.tempdostable_dbp).trigger("change");
						$("#dof").val(data.tempdostable_dof).trigger("change");
						$("#cc").val(data.tempdostable_cc).trigger("change");
						$("#ca").val(data.tempdostable_ca).trigger("change");
						$("#lf").val(data.tempdostable_lf).trigger("change");
						$("#bvm").val(data.tempdostable_bvm).trigger("change");
						$("#lh").val(data.tempdostable_lh).trigger("change");
						$("#cerebelo").val(data.tempdostable_cerebelo).trigger("change");
						$("#pfe").val(data.tempdostable_pfe).trigger("change");
						$("#egP50").val(data.tempdostable_egP50).trigger("change");
						$("#presentacion").val(data.tempdostable_presentacion).trigger("change");
						$("#dorso").val(data.tempdostable_dorso).trigger("change");
						$("#fcf").val(data.tempdostable_fcf).trigger("change");
						$("#ecografia\\.segtrim\\.sexo").val(data.tempdostable_sexo).trigger("change");
						$("#ev-morfo option:selected").val(data.tempdostable_morfo).trigger("change");
						$("#comentarios-anatomia-informe-eg-texto").val(data.tempdostable_anatomia).trigger("change");
						$("#ubicacion").val(data.tempdostable_ubicacion).trigger("change");
						...
						$("#comentarios-eco-dos-inf-dos").val(data.tempdostable_comentarios).trigger("change");
			...
			if (Object.keys(data).length > 0) {
				...
				$('#tabla\\.tres > tr').on("click", function(){
					...
					$.post("https://pacientes.crecimientofetal.cl/temporal/tercero", args).done(function(data){
						...
						$("#semanasEcoGen").val(eg[0]);
						$("#diasEcoGen").val(eg[1]);
						$("#aud").val(data.temptrestable_utd).trigger("change");
						$("#aui").val(data.temptrestable_uti).trigger("change");
						$("#auprom").val(data.temptrestable_put).trigger("change");
						$("#ipau").val(data.temptrestable_au).trigger("change");
						$("#ipacm").val(data.temptrestable_cm).trigger("change");
						$("#ccp").val(data.temptrestable_cp).trigger("change");
						$("#dv").val(data.temptrestable_dv).trigger("change");
						$("#psmACM").val(data.temptrestable_acm).trigger("change");
